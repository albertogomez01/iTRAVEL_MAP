...
import { Map, Train, Bus, Plane, Ship, Footprints, Bed, Moon, MapPin, Info, AlertCircle, Coffee, Camera, Landmark, Clock, ExternalLink, ChevronDown, ChevronUp, Wallet, MessageSquarePlus, Sparkles } from 'lucide-react';
            ...
            >
              ...
              {isSelected && (
                <div className="border-t border-slate-100 bg-slate-50/50 p-4 sm:p-6">
                  ...
                  {/* Enlaces de Reserva con botón de consultar */}
